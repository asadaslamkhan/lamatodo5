    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4">
        <button
          ...
          className={`mr-2 ${filter === "All" ? "bg-blue-500 text-white" : "bg-gray-300 text-black"} p-2 rounded hover:bg-blue-600`}
        >
          All
        </button>
        <button
          onClick={() => setFilter("Active")}
          className={`mr-2 ${filter === "Active" ? "bg-blue-500 text-white" : "bg-gray-300 text-black"} p-2 rounded hover:bg-blue-600`}
        >
          Active
        </button>
        <button
          onClick={() => setFilter("Completed")}
          className={`${filter === "Completed" ? "bg-blue-500 text-white" : "bg-gray-300 text-black"} p-2 rounded hover:bg-blue-600`}
        >
          Completed
        </button>
      </div>
